...
ip_CNN_1D.predict_data(model_path="indian-pines/model/CNN-1D/model.hdf5",
                       data_dir="indian-pines/model/CNN-1D")
...
ip_CNN_3D.predict_data(model_path="indian-pines/model/CNN-3D/model.hdf5",
                       data_dir="indian-pines/model/CNN-3D")
...
ip_CNN_1D_eval.load_data(
    ...
    y_pred_path="indian-pines/model/CNN-1D/y_pred.hdf5",
    y_test_pred_path="indian-pines/model/CNN-1D/y_test_pred.hdf5")
...
ip_CNN_3D_eval.load_data(
    ...
    y_pred_path="indian-pines/model/CNN-3D/y_pred.hdf5",
    y_test_pred_path="indian-pines/model/CNN-3D/y_test_pred.hdf5")
