...
pu_1D_CNN.prepare_data(train_ratio=0.4, test_ratio=0.5, validation_ratio=0.1)
...
pu_3D_CNN.fit_PCA(n_components=15, whiten=False)
pu_3D_CNN.prepare_data(train_ratio=0.4, test_ratio=0.5, validation_ratio=0.1)
